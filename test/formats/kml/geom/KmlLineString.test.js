...
describe("KmlLineString", function () {
  ...
  it("should have the length ans position properties", function () {
    ...
    expect(lineString.kmlPositions[0].longitude).toEqual(
      new Position(37.824787, -122.364167, 0).longitude
    );
    expect(lineString.kmlPositions[0].latitude).toEqual(
      new Position(37.824787, -122.364167, 0).latitude
    );
    expect(lineString.kmlPositions[0].altitude).toEqual(
      new Position(37.824787, -122.364167, 0).altitude
    );
    expect(lineString.kmlPositions[1].longitude).toEqual(
      new Position(37.824423, -122.363917, 0).longitude
    );
    expect(lineString.kmlPositions[1].latitude).toEqual(
      new Position(37.824423, -122.363917, 0).latitude
    );
    expect(lineString.kmlPositions[1].altitude).toEqual(
      new Position(37.824423, -122.363917, 0).altitude
    );
  });
