...
import   WktTokens from "../../../src/formats/wkt/WktTokens.js"
...
describe("WktTokens", function () {
  describe("Point", function () {
    it("correctly parses 2D point", function () {
      ...
      expect(
        wktObjects[0].coordinates[0].equals(new Location(14.5, 50))
      ).toBeTruthy();
    });
    ...
    it("correctly parses 3D point", function () {
      ...
      expect(wktObjects[0] instanceof WktPoint).toBeTruthy();
      expect(
        wktObjects[0].coordinates[0].equals(new Position(14.5, 50, 13))
      ).toBeTruthy();
    });
    ...
    it("correctly ignores the LRS for 3D point", function () {
      ...
      expect(wktObjects[0] instanceof WktPoint).toBeTruthy();
      expect(
        wktObjects[0].coordinates[0].equals(new Position(14.5, 50, 10))
      ).toBeTruthy();
    });
  });
  ...
  describe("Polygon", function () {
    it("correctly parses 2D polygon", function () {
      ...
      expect(
        equalLocations(wktObjects[0].coordinates, [
          new Location(40, -70),
          new Location(45, -80),
          new Location(40, -90),
        ])
    ...
    it("correctly parses 3D polygon with inner boundaries", function () {
      var polygon =
        "POLYGON Z ((40 -70 10, 45 -80 10, 40 -90 10), (42 -75 10, 44 -78 10, 42 -73 10))";
    ...
    it("correctly parses 3D polygon", function () {
      ...
      expect(
        equalLocations(wktObjects[0].coordinates, [
          new Position(40, -70, 10),
          new Position(45, -80, 10),
          new Position(40, -90, 10),
        ])
      ).toBeTruthy();
    });
  ...
  describe("LineString", function () {
    ...
    it("correctly parses 3D line string", function () {
      ...
      expect(
        equalLocations(wktObjects[0].coordinates, [
          new Position(33, -75, 10),
          new Position(37, -80, 10),
          new Position(33, -85, 10),
        ])
      ).toBeTruthy();
    });
    ...
    it("correctly ignores LRS for 3D line string", function () {
      var polygon2D =
        "LINESTRING MZ((33 -75 10 10, 37 -80 10 10, 33 -85 10 10))";
      var wktObjects = new WktTokens(polygon2D).objects();
  ...
  describe("MultiPoint", function () {
    it("correctly parses 2D point", function () {
      ...
      expect(
        wktObjects[0].shapes()[0].position.equals(new Location(17, 49.3))
      ).toBeTruthy();
      expect(
        wktObjects[0].shapes()[1].position.equals(new Location(-17, 49))
      ).toBeTruthy();
    });
    ...
    it("correctly parses 3D point", function () {
      ...
      expect(wktObjects[0].shapes().length).toBe(2);
      expect(
        wktObjects[0].shapes()[0].position.equals(new Position(17, 49.3, 10))
      ).toBeTruthy();
      expect(
        wktObjects[0].shapes()[1].position.equals(new Position(-17, 49, 1))
      ).toBeTruthy();
    });
  ...
  describe("MultiLineString", function () {
    it("correctly parses 2D Multi Line String", function () {
      ...
      expect(
        equalLocations(wktObjects[0].shapes()[0]._boundaries, [
          new Location(38, -70),
          new Location(42, -75),
          new Location(38, -80),
        ])
      ...
      expect(
        equalLocations(wktObjects[0].shapes()[1]._boundaries, [
          new Location(43, -65),
          new Location(47, -70),
          new Location(43, -75),
        ])
    ...
    it("correctly parses 2D Multi Line String with LRS", function () {
      var multiLineString =
        "MULTILINESTRING M((38 -70 10, 42 -75 10, 38 -80 10),(43 -65 10, 47 -70 10, 43 -75 10))";
      var wktObjects = new WktTokens(multiLineString).objects();
    ...
    it("correctly parses 3D Line String", function () {
      ...
      // Get coordinates from Path and verify against the expectations.
      expect(
        equalLocations(wktObjects[0].shapes()[0]._positions, [
          new Position(38, -70, 10),
          new Position(42, -75, 10),
          new Position(38, -80, 10),
        ])
      ).toBeTruthy();
      expect(
        equalLocations(wktObjects[0].shapes()[1]._positions, [
          new Position(43, -65, 10),
          new Position(47, -70, 10),
          new Position(43, -75, 10),
        ])
      ).toBeTruthy();
    });
    ...
    it("correctly parses 3D Line String with LRS", function () {
      var multiLineString =
        "MULTILINESTRING MZ((38 -70 10 12, 42 -75 10 12, 38 -80 10 12),(43 -65 10 12, 47 -70 10 12, 43 -75 10 12))";
      var wktObjects = new WktTokens(multiLineString).objects();
  ...
  describe("MultiPolygon", function () {
    it("correctly parses 2D Multi polygon", function () {
      var multiPolygon =
        "MULTIPOLYGON (((50 -60, 55 -70, 50 -80)),((30 -60, 35 -70, 30 -80)))";
      ...
      expect(
        equalLocations(wktObjects[0].shapes()[0]._boundaries[0], [
          new Location(50, -60),
          new Location(55, -70),
          new Location(50, -80),
        ])
      ...
      expect(
        equalLocations(wktObjects[0].shapes()[1]._boundaries[0], [
          new Location(30, -60),
          new Location(35, -70),
          new Location(30, -80),
        ])
    ...
    it("correctly parses 3D Multi polygon with inner boundaries", function () {
      var multiPolygon =
        "MULTIPOLYGON Z (((50 -60 10, 55 -70 10, 50 -80 10)),((40 -70 10, 45 -80 10, 40 -90 10), (42 -75 10, 44 -78 10, 42 -73 10)))";
      var wktObjects = new WktTokens(multiPolygon).objects();
      ...
      expect(
        equalLocations(wktObjects[0].shapes()[0]._boundaries[0], [
          new Position(50, -60, 10),
          new Position(55, -70, 10),
          new Position(50, -80, 10),
        ])
      ).toBeTruthy();
    ...
    it("correctly parses 2D Multi polygon with LRS", function () {
      var multiPolygon =
        "MULTIPOLYGON M (((50 -60 10, 55 -70 10, 50 -80 10)),((30 -60 10, 35 -70 10, 30 -80 10)))";
      var wktObjects = new WktTokens(multiPolygon).objects();
    ...
    it("correctly parses 3D Multi Polygon", function () {
      ...
      expect(
        equalLocations(wktObjects[0].shapes()[1]._boundaries[0], [
          new Position(30, -60, 10),
          new Position(35, -70, 10),
          new Position(30, -80, 10),
        ])
      ).toBeTruthy();
    });
    ...
    it("correctly parses 3D Multi Polygon with LRS", function () {
      var multiPolygon =
        "MULTIPOLYGON MZ (((50 -60 10 10, 55 -70 10 10, 50 -80 10 10)),((30 -60 10 10, 35 -70 10 10, 30 -80 10 10)))";
      var wktObjects = new WktTokens(multiPolygon).objects();
