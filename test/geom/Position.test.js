...
describe("Position Tests", function () {
  ...
  describe("Computes a position along a great circle path", function () {
    var positionA = new Position(37.52, 15.0, 120);
    ...
    describe("Exceptions", function () {
      it("Position A not provided", function () {
        expect(function () {
          Position.interpolateGreatCircle(0.5, null, positionB, new Position());
        }).toThrow();
      });

      it("Position B not provided", function () {
        expect(function () {
          Position.interpolateGreatCircle(0.5, positionA, null, new Position());
        }).toThrow();
      });

      it("Result storage not provided", function () {
        expect(function () {
          Position.interpolateGreatCircle(0.5, positionA, positionB, null);
        }).toThrow();
      });
    });
  });
  ...
  describe("Computes a position along a rhumb path", function () {
    var positionA = new Position(37.52, 15.0, 150);
    ...
    describe("Exceptions", function () {
      it("Position A not provided", function () {
        expect(function () {
          Position.interpolateRhumb(0.5, null, positionB, new Position());
        }).toThrow();
      });

      it("Position B not provided", function () {
        expect(function () {
          Position.interpolateRhumb(0.5, positionA, null, new Position());
        }).toThrow();
      });

      it("Result storage not provided", function () {
        expect(function () {
          Position.interpolateRhumb(0.5, positionA, positionB, null);
        }).toThrow();
      });
    });
  });
  ...
  describe("Computes a position along a linear path", function () {
    ...
    describe("Exceptions", function () {
      it("Position A not provided", function () {
        expect(function () {
          Position.interpolateLinear(0.5, null, positionB, new Position());
        }).toThrow();
      });

      it("Position B not provided", function () {
        expect(function () {
          Position.interpolateLinear(0.5, positionA, null, new Position());
        }).toThrow();
      });

      it("Result storage not provided", function () {
        expect(function () {
          Position.interpolateLinear(0.5, positionA, positionB, null);
        }).toThrow();
      });
    });
  });
  ...
  it("Returns a string representation of this position", function () {
    var position = new Position(37.52, 15.0, 120);
