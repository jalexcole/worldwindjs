...
describe("Sector Tests", function () {
  ...
  it("Returns this sector's maximum latitude in radians", function () {
    ...
    expect(maxLatitudeRadians).toBeCloseTo(0.68);
  });
  ...
  describe("Compute bounding points method", function () {
    ...
    it("Computes the correct bounding points for a given sector", function () {
      ...
      var boundingPoints = sector.computeBoundingPoints(
        mockGlobe,
        1 /* verticalExaggeration */
      );
      var results = [
        -4578078.756, 4408178.4447, -400529.9919, -4578239.9915, 4408334.7429,
        -400544.0982, -4584371.7046, 4408178.4447, -320570.4981, -4584533.1618,
        4408334.7429, -320581.7883, -4506674.4276, 4487436.7972, -315137.3752,
        -4506833.139, 4487595.8962, -315148.4734, -4500488.1337, 4487436.7972,
        -393741.692, -4500646.6273, 4487595.8962, -393755.5584, -4542910.2988,
        4448133.508, -357534.7945, -4581561.0285, 4408334.7429, -360576.6729,
      ];
    ...
    it("Computes the correct bounding points for a sector crossing the anti-Meridian", function () {
      ...
      var results = [
        -80203.6904, 4408178.4447, -4594866.3461, -80206.5151, 4408334.7429,
        -4595028.1729, 80203.6904, 4408178.4447, -4594866.3461, 80206.5151,
        4408334.7429, -4595028.1729, 78844.3747, 4487436.7972, -4516991.2028,
        78847.1514, 4487595.8962, -4517150.2776, -78844.3747, 4487436.7972,
        -4516991.2028, -78847.1514, 4487595.8962, -4517150.2776, 0.0,
        4448133.508, 4556957.8791, 0.0, 4408334.7429, 4595728.1245,
        -4556784.3641, 4448133.508, 39766.4547, 4556784.3641, 4448133.508,
        39766.4547, -79529.881, 4448133.508, -4556263.8324, 79529.881,
        4448133.508, -4556263.8324,
      ];
    ...
    it("Computes the correct bounding points for a sector spanning the globe horizontally", function () {
      ...
      var results = [
        -0.0, 4408178.4447, -4595566.2731, -0.0, 4408334.7429, -4595728.1245,
        0.0, 4408178.4447, -4595566.2731, 0.0, 4408334.7429, -4595728.1245, 0.0,
        4487436.7972, -4517679.2672, 0.0, 4487595.8962, -4517838.3662, 0.0,
        4487436.7972, -4517679.2672, -0.0, 4487595.8962, -4517838.3662, 0.0,
        4448133.508, 4556957.8791, 0.0, 4408334.7429, 4595728.1245, 0.0,
        4408334.7429, 4595728.1245, 4595728.1245, 4408334.7429, 0.0,
        -4595728.1245, 4408334.7429, 0.0, 0.0, 4408334.7429, -4595728.1245, 0.0,
        4487595.8962, 4517838.3662, 4517838.3662, 4487595.8962, 0.0,
        -4517838.3662, 4487595.8962, 0.0, 0.0, 4487595.8962, -4517838.3662,
      ];
    ...
    it("Computes the correct bounding points for a sector in the southern hemisphere", function () {
      ...
      var results = [
        -4500488.1337, -4487436.7972, -393741.692, -4500646.6273, -4487595.8962,
        -393755.5584, -4506674.4276, -4487436.7972, -315137.3752, -4506833.139,
        -4487595.8962, -315148.4734, -4584371.7046, -4408178.4447, -320570.4981,
        -4584533.1618, -4408334.7429, -320581.7883, -4578078.756, -4408178.4447,
        -400529.9919, -4578239.9915, -4408334.7429, -400544.0982, -4542910.2988,
        -4448133.508, -357534.7945, -4581561.0285, -4408334.7429, -360576.6729,
      ];
    ...
    it("Computes the correct bounding points for a sector crossing the equator", function () {
      ...
      var results = [
        -6258091.0395, -1100270.2538, -547512.0213, -6258311.778, -1100309.3246,
        -547531.3334, -6266693.3042, -1100270.2538, -438209.8842, -6266914.3462,
        -1100309.3246, -438225.341, -6266693.3042, 1100270.2538, -438209.8842,
        -6266914.3462, 1100309.3246, -438225.341, -6258091.0395, 1100270.2538,
        -547512.0213, -6258311.778, 1100309.3246, -547531.3334, -6358824.2533,
        0.0, -500450.3221, -6262851.5323, -1100309.3246, -492897.1052,
        -6262851.5323, 1100309.3246, -492897.1052, -6354214.9312, 0.0,
        -555921.7721, -6362949.3262, 0.0, -444940.7609,
      ];
  ...
  describe("Computes points and distances", function () {
    ...
    it("Computes corner points", function () {
      ...
      const corners = [
        new Vec3(
          -4.798926572645884e-26,
          -6356752.314245179,
          -3.9186209248144716e-10
        ),
        new Vec3(
          -2.770883428835813e-10,
          -6356752.314245179,
          -2.7708834288358126e-10
        ),
        new Vec3(-3194419.1450605746, -4487348.408865919, -3194419.145060574),
        new Vec3(
          -5.532453209639622e-10,
          -4487348.408865919,
          -4517590.878848932
        ),
      ];
