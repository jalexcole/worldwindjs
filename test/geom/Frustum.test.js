...
describe("Frustum Tests", function () {
  ...
  describe("Extracts a frustum from a projection matrix", function () {
    it("Extracts the correct frustum properties", function () {
      ...
      var leftExpected = new Plane(
        0.5025707110324167,
        0.5743665268941905,
        0.6461623427559643,
        0.7179581586177382
      );
      var rightExpected = new Plane(
        0.5773502691896257,
        0.5773502691896257,
        0.5773502691896257,
        0.5773502691896257
      );
      var bottomExpected = new Plane(
        0.5178918038835925,
        0.575435337648436,
        0.6329788714132796,
        0.6905224051781232
      );
      var topExpected = new Plane(
        0.5773502691896258,
        0.5773502691896258,
        0.5773502691896258,
        0.5773502691896258
      );
      var nearExpected = new Plane(
        0.5280168968110512,
        0.5760184328847832,
        0.6240199689585151,
        0.672021505032247
      );
      var farExpected = new Plane(
        0.5773502691896258,
        0.5773502691896258,
        0.5773502691896258,
        0.5773502691896258
      ...
      expect(frustum._planes).toEqual([
        leftExpected,
        rightExpected,
        topExpected,
        bottomExpected,
