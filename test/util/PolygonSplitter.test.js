...
describe("spilt polygons", function () {
  ...
  it("splits a polygon that contains the south pole and intersects the anti-meridian", function () {
    var inputContours =
      PolygonSplitterData.polygonSouthPoleAndIntersectionInput;
    var expectedResult =
      PolygonSplitterData.polygonSouthPoleAndIntersectionOutput;
    var result = [];
    var doesCross = PolygonSplitter.splitContours(inputContours, result);
    expect(expectedResult).toEqual(result);
    expect(doesCross).toEqual(true);
  ...
  it("splits a polygon that contains the north pole and intersects the anti-meridian", function () {
    var inputContours =
      PolygonSplitterData.polygonNorthPoleAndIntersectionInput;
    var expectedResult =
      PolygonSplitterData.polygonNorthPoleAndIntersectionOutput;
    var result = [];
    var doesCross = PolygonSplitter.splitContours(inputContours, result);
    expect(expectedResult).toEqual(result);
    expect(doesCross).toEqual(true);
