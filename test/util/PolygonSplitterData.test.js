...
class PolygonSplitterData {
  static transformOutputData(rawContours) {
  ...
  static transformInputData(rawContours) {
    return rawContours.map(function (contour) {
  ...
  static simpleSquareInput = [
    [
      new Location(30, 170),
      new Location(33.11, 179.94),
      new Location(30, -170),
      new Location(33.1, -178.86),
      new Location(20, -170),
      new Location(25.57, -179.64),
      new Location(25.6, 178.99),
      new Location(20, 170),
    ],
  ];
  static simpleSquareRawOutput = [
    {
      polygons: [
        [
          {
  ...
  static simpleSquareOutput = PolygonSplitterData.transformOutputData(PolygonSplitterData.simpleSquareRawOutput);

  static spiralPolyRawInput = [
    [
      {
  ...
  static spiralPolyInput = PolygonSplitterData.transformInputData(PolygonSplitterData.spiralPolyRawInput);
  static spiralPolyRawOutput = [
    {
      polygons: [
        [
          {
  ...
  static spiralPolyOutput = PolygonSplitterData.transformOutputData(PolygonSplitterData.spiralPolyRawOutput);

  static polyLineRawInput = [
    [
      {
        latitude: 90,
        longitude: -180,
  ...
  static polyLineInput = PolygonSplitterData.transformInputData(PolygonSplitterData.polyLineRawInput);
  static polyLineRawOutput = [
    {
      polygons: [
        [
          {
  ...
  static polyLineOutput = PolygonSplitterData.transformOutputData(PolygonSplitterData.polyLineRawOutput);

  static polygonOverTheGlobeRawInput = [
    [
      {
        latitude: 45.05,
        longitude: 168.79,
  ...
  static polygonOverTheGlobeInput = PolygonSplitterData.transformInputData(
    PolygonSplitterData.polygonOverTheGlobeRawInput
  );
  static polygonOverTheGlobeRawOutput = [
    {
      polygons: [
        [
          {
  ...
  static polygonOverTheGlobeOutput = PolygonSplitterData.transformOutputData(
    PolygonSplitterData.polygonOverTheGlobeRawOutput
  );

  static polygonSouthPoleAndIntersectionRawInput = [
    [
      {
  ...
  static polygonSouthPoleAndIntersectionInput = PolygonSplitterData.transformInputData(
    PolygonSplitterData.polygonSouthPoleAndIntersectionRawInput
  );
  static polygonSouthPoleAndIntersectionRawOutput = [
    {
      polygons: [
        [
          {
  ...
  static polygonSouthPoleAndIntersectionOutput = PolygonSplitterData.transformOutputData(
    PolygonSplitterData.polygonSouthPoleAndIntersectionRawOutput
  );

  static polygonNorthPoleAndIntersectionRawInput = [
    [
      {
  ...
  static polygonNorthPoleAndIntersectionInput = PolygonSplitterData.transformInputData(
    PolygonSplitterData.polygonNorthPoleAndIntersectionRawInput
  );
  static polygonNorthPoleAndIntersectionRawOutput = [
    {
      polygons: [
        [
          {
  ...
  static polygonNorthPoleAndIntersectionOutput = PolygonSplitterData.transformOutputData(
    PolygonSplitterData.polygonNorthPoleAndIntersectionRawOutput
  );

  static polygonHoleRawInput = [
    [
      {
        latitude: 40,
        longitude: -168,
  ...
  static polygonHoleInput = PolygonSplitterData.transformInputData(PolygonSplitterData.polygonHoleRawInput);
  static polygonHoleRawOutput = [
    {
      polygons: [
        [
          {
  ...
  static polygonHoleOutput = PolygonSplitterData.transformOutputData(PolygonSplitterData.polygonHoleRawOutput);

  static polygonHole2RawInput = [
    [
      {
        latitude: 40,
        longitude: -178,
  ...
  static polygonHole2Input = PolygonSplitterData.transformInputData(PolygonSplitterData.polygonHole2RawInput);
  static polygonHole2RawOutput = [
    {
      polygons: [
        [
          {
  ...
  static polygonHole2Output = PolygonSplitterData.transformOutputData(PolygonSplitterData.polygonHole2RawOutput);

  static fullSphereSectorRawInput = [
    [
      {
        latitude: -90,
        longitude: -180,
  ...
  static fullSphereSectorInput = PolygonSplitterData.transformInputData(PolygonSplitterData.fullSphereSectorRawInput);
  static fullSphereSectorRawOutput = [
    {
      polygons: [
        [
          {
  ...
  static fullSphereSectorOutput = PolygonSplitterData.transformOutputData(
    PolygonSplitterData.fullSphereSectorRawOutput
  );
}

export default PolygonSplitterData;
