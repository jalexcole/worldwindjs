...
describe("WWUtil-arrayEquals", function () {
  ...
  if (
    ("testDifferentArraysDifferentLength",
    function () {
      var array1 = [1, 2, 3];
      var array2 = [1, 2, 3, 4];
