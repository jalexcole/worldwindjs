...
describe("Constructor testing", function () {
  it("should throw an exception when nothing is provided as an argument", function () {
    expect(function () {
      new WcsCoverageDescriptions(null);
    }).toThrow();
  });
});
...
describe("WSC 1.0.0 Describe Coverage", function () {
  ...
  describe("Utility Methods", function () {
    ...
    it("should report a resolution of 0.008334 degrees", function () {
      ...
      var actualResolution =
        wcsCoverageDescriptions.getResolution("testing:gebco");
    ...
    it("should provide the request/response crs", function () {
      ...
      var supportedCrs =
        wcsCoverageDescriptions.getSupportedCrs("testing:gebco");
  ...
  it("should have a lonLatEnvelope srs of CRS84", function () {
    ...
    var lonLatEnvelopSrs =
      wcsCoverageDescriptions.coverages[0].lonLatEnvelope.srsName;
  ...
  it("should show support for the EPSG:4326 CRS", function () {
    ...
    var supportedRequestCrs =
      wcsCoverageDescriptions.coverages[0].supportedCrs.requests[0];
    var supportedResponseCrs =
      wcsCoverageDescriptions.coverages[0].supportedCrs.responses[0];
  ...
  describe("Supported Formats", function () {
    it("should have 12 supported formats", function () {
      ...
      var supportedFormatsCount =
        wcsCoverageDescriptions.coverages[0].supportedFormats.formats.length;
    ...
    it("should show a native format of GeoTIFF", function () {
      ...
      var nativeFormat =
        wcsCoverageDescriptions.coverages[0].supportedFormats.nativeFormat;
    ...
    it("should have support for GeoPackage (tiles)", function () {
      ...
      var formatSupported =
        wcsCoverageDescriptions.coverages[0].supportedFormats.formats[3];
  ...
  describe("Supported Interpolations", function () {
    it("should have three supported interpolation methods", function () {
      ...
      var numberOfSupportedInterpolationMethods =
        wcsCoverageDescriptions.coverages[0].supportedInterpolations.methods
          .length;
    ...
    it("should show a default nearest neighbor interpolation method", function () {
      ...
      var defaultInterpolation =
        wcsCoverageDescriptions.coverages[0].supportedInterpolations.default;
    ...
    it("should support bilinear interpolation", function () {
      ...
      var bilinearInterpolationMethod =
        wcsCoverageDescriptions.coverages[0].supportedInterpolations.methods[1];
  ...
  describe("Spatial Domain Set", function () {
    it("Should have an envelope with an EPSG:4326 srs name", function () {
      ...
      var envelopSrsName =
        wcsCoverageDescriptions.coverages[0].domainSet.spatialDomain.envelope
          .srsName;
    ...
    it("should have the correct axis names of x and y", function () {
      ...
      var axisNames =
        wcsCoverageDescriptions.coverages[0].domainSet.spatialDomain
          .rectifiedGrid.axisNames;
    ...
    it("should have offset vector values of 0.0 0.008333333333333333 for the first offset", function () {
      ...
      var values =
        wcsCoverageDescriptions.coverages[0].domainSet.spatialDomain
          .rectifiedGrid.offsetVector[0].values;
    ...
    it("should have offset vector values of -0.008333333333333333 0.0 for the second offset", function () {
      ...
      var values =
        wcsCoverageDescriptions.coverages[0].domainSet.spatialDomain
          .rectifiedGrid.offsetVector[1].values;
  ...
  describe("Range Set", function () {
    ...
    it("should have a range set axis description name: Band", function () {
      ...
      var rangeSetAxisName =
        wcsCoverageDescriptions.coverages[0].rangeSet.axisDescriptions[0].name;
    ...
    it("should have a range set axis description label: Band", function () {
      ...
      var rangeSetAxisLabel =
        wcsCoverageDescriptions.coverages[0].rangeSet.axisDescriptions[0].label;
...
describe("WSC 2.0.1 Describe Coverage", function () {
  ...
  describe("Utility Methods", function () {
    ...
    it("should report a resolution of 0.008334 degrees", function () {
      ...
      var actualResolution =
        wcsCoverageDescriptions.getResolution("testing__gebco");
    ...
    it("should provide the request/response crs", function () {
      ...
      var supportedCrs =
        wcsCoverageDescriptions.getSupportedCrs("testing__gebco");
  ...
  describe("Domain Set", function () {
    it("should have the correct gml:id of grid00__testing__gebco", function () {
      ...
      var gmlDomainSetId =
        wcsCoverageDescriptions.coverages[0].domainSet.rectifiedGrid.id;
    ...
    it("should have the correct axis labels of i and j", function () {
      ...
      var axisLabels =
        wcsCoverageDescriptions.coverages[0].domainSet.rectifiedGrid.axisLabels;
    ...
    it("should have an origin of 89.99583333333334 -179.99583333333334", function () {
      ...
      var pos =
        wcsCoverageDescriptions.coverages[0].domainSet.rectifiedGrid.origin
          .point.pos.pos;
    ...
    it("should have a low grid envelope of 0, 0", function () {
      ...
      var lowEnvelope =
        wcsCoverageDescriptions.coverages[0].domainSet.rectifiedGrid.limits.low;
    ...
    it("should have a high grid envelope of 43199, 21599", function () {
      ...
      var highEnvelope =
        wcsCoverageDescriptions.coverages[0].domainSet.rectifiedGrid.limits
          .high;
    ...
    it("should have an offset vector srsName of 4326 for the first and second offsets", function () {
      ...
      var offsetSrsOne =
        wcsCoverageDescriptions.coverages[0].domainSet.rectifiedGrid
          .offsetVector[0].srsName;
      var offsetSrsTwo =
        wcsCoverageDescriptions.coverages[0].domainSet.rectifiedGrid
          .offsetVector[1].srsName;
  ...
  describe("BoundedBy", function () {
    it("should have a bounded by envelope srs name of http://www.opengis.net/def/crs/EPSG/0/4326", function () {
      ...
      var boundedBySrsName =
        wcsCoverageDescriptions.coverages[0].boundedBy.envelope.srsName;

      expect(boundedBySrsName).toBe(
    ...
    it("should have a bounded by envelope axis labels of Lat and Lon", function () {
      ...
      var boundedByAxisLabels =
        wcsCoverageDescriptions.coverages[0].boundedBy.envelope.axisLabels;
    ...
    it("should have a bounded by envelope uom labels of Deg and Deg", function () {
      ...
      var boundedByUomLabels =
        wcsCoverageDescriptions.coverages[0].boundedBy.envelope.uomLabels;
    ...
    it("should have a bounded by envelope srs dimension of 2", function () {
      ...
      var boundedBySrsDimension =
        wcsCoverageDescriptions.coverages[0].boundedBy.envelope.srsDimension;
    ...
    it("should have a bounded by envelope lower corner of -90.0 and -180.0", function () {
      ...
      var boundedByLowerCorner =
        wcsCoverageDescriptions.coverages[0].boundedBy.envelope.lower;
    ...
    it("should have a bounded by envelope upper corner of 90.0 and 180.0", function () {
      ...
      var boundedByUpperCorner =
        wcsCoverageDescriptions.coverages[0].boundedBy.envelope.upper;
  ...
  describe("Service Parameters", function () {
    it("should have a subtype of RectifiedGridCoverage", function () {
      ...
      var serviceParameterSubtype =
        wcsCoverageDescriptions.coverages[0].serviceParameters.coverageSubtype;
    ...
    it("should have a native format of image/tiff", function () {
      ...
      var serviceParameterNativeFormat =
        wcsCoverageDescriptions.coverages[0].serviceParameters.nativeFormat;
