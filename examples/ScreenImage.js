...
requirejs(
  ...
  function (WorldWind, LayerManager) {
    ...
    var screenImage1 = new WorldWind.ScreenImage(
      screenOffset,
      "data/400x230-splash-nww.png"
    );
    screenImage1.imageOffset = new WorldWind.Offset(
      WorldWindConstants.OFFSET_FRACTION,
      1,
      WorldWindConstants.OFFSET_FRACTION,
      0
    ...
    screenOffset = new WorldWind.Offset(
      WorldWindConstants.OFFSET_FRACTION,
      0,
      WorldWindConstants.OFFSET_FRACTION,
      1
    );
    var screenImage2 = new WorldWind.ScreenImage(
      screenOffset,
      new WorldWind.ImageSource(canvas)
    );
    screenImage2.imageOffset = new WorldWind.Offset(
      WorldWindConstants.OFFSET_FRACTION,
      0,
      WorldWindConstants.OFFSET_FRACTION,
      1
      ...
      if (pickList.objects.length > 0) {
        for (var p = 0; p < pickList.objects.length; p++) {
          ...
          if (pickList.objects[p].userObject instanceof WorldWind.Compass) {
            ...
            pickList.objects[p].userObject instanceof WorldWind.ScreenImage
          ) {
