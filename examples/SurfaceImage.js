...
requirejs(
  ...
  function (WorldWind, LayerManager) {
    ...
    var surfaceImage2 = new WorldWind.SurfaceImage(
      new WorldWind.Sector(50, 60, -80, -60),
      "data/surface-image-nearest.png"
    );
    surfaceImage2.resamplingMode = WorldWindConstants.FILTER_NEAREST; // or FILTER_LINEAR by default
    ...
    var surfaceImage3 = new WorldWind.SurfaceImage(
      new WorldWind.Sector(30, 40, -100, -80),
