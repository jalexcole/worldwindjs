...
requirejs(["./WorldWindShim", "./LayerManager"], function (ww, LayerManager) {
  "use strict";
  ...
  var newCreatedShapesLayer = new WorldWind.RenderableLayer(
    "New Created Surface Shapes"
  );
  ...
  var circleShape = new WorldWind.SurfaceCircle(
    new WorldWind.Location(35, -110),
    200e3,
    attributes
  );
  ...
  var ellipseShape = new WorldWind.SurfaceEllipse(
    new WorldWind.Location(35, -98),
    300e3,
    200e3,
    45,
    attributes
  ...
  var polygonShape = new WorldWind.SurfacePolygon(
    polygonBoundaries,
    attributes
  );
  ...
  var multiPolygonShape = new WorldWind.SurfacePolygon(
    multiPolygonBoundaries,
    attributes
  );
  ...
  var rectangleShape = new WorldWind.SurfaceRectangle(
    new WorldWind.Location(33, -105),
    300e3,
    200e3,
    70,
    attributes
  ...
  var sectorShape = new WorldWind.SurfaceSector(
    new WorldWind.Sector(45, 47, -110, -100),
    attributes
  );
  ...
  var placemark = new WorldWind.Placemark(
    new WorldWind.Position(41, -95, 0),
    false,
    null
  );
  ...
  wwd.goTo(new WorldWind.Position(40.42, -104.6, 2417000));
  ...
  document
    .getElementById("createCircleBtn")
    .addEventListener("click", function () {
      ...
      shapeEditor.enableCreator(
        WorldWind.SurfaceCircle,
        properties,
        newCreatedShapesLayer
      );
  ...
  document
    .getElementById("createEllipseBtn")
    .addEventListener("click", function () {
      var properties = {
        majorRadius: 300e3,
        minorRadius: 200e3,
  ...
  document
    .getElementById("createRectangleBtn")
    .addEventListener("click", function () {
      var properties = {
        width: 300e3,
        height: 200e3,
  ...
  document
    .getElementById("createSectorBtn")
    .addEventListener("click", function () {
      var properties = {
        attributes: attributes,
      };
  ...
  document
    .getElementById("editPlacemarkBtn")
    .addEventListener("click", function () {
      var shape = shapeEditor.stop();
      if (shape !== placemark) {
  ...
  document
    .getElementById("editMultiPolygonBtn")
    .addEventListener("click", function () {
      var shape = shapeEditor.stop();
  ...
  document
    .getElementById("editPolylineBtn")
    .addEventListener("click", function () {
      var shape = shapeEditor.stop();
  ...
  document
    .getElementById("editRectangleBtn")
    .addEventListener("click", function () {
      var shape = shapeEditor.stop();
