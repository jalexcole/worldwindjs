...
AnnotationController.prototype.changeTextColor = function (r, g, b) {
  ...
  this.currentAnnotation.attributes.textAttributes.color =
    WorldWind.Color.colorFromBytes(r, g, b, 255);
...
AnnotationController.prototype.changeBackgroundColor = function (r, g, b) {
  ...
  this.currentAnnotation.attributes.backgroundColor =
    WorldWind.Color.colorFromBytes(r, g, b, 255);
  this.worldWindow.redraw();
};
