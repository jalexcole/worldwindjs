...
requirejs(
  ...
  function (WorldWind, LayerManager) {
    ...
    shape = new WorldWind.SurfaceEllipse(
      new WorldWind.Location(30.0, -104.95),
      300e3,
      200e3,
      0,
      attributes
    ...
    shape = new WorldWind.SurfaceCircle(
      new WorldWind.Location(35.76, -113.7),
      200e3,
      attributes
    );
    shapesLayer.addRenderable(shape);

    shape = new WorldWind.SurfaceRectangle(
      new WorldWind.Location(30.73, -96.49),
      200e3,
      300e3,
      30,
      attributes
    ...
    shape = new WorldWind.SurfaceSector(
      new WorldWind.Sector(33, 37, -88, -83),
      attributes
    );
    shapesLayer.addRenderable(shape);
    ...
    function onExportWkt() {
      ...
      var exportedWkt = WorldWind.WktExporter.exportRenderables(
        shapesLayer.renderables
      );
