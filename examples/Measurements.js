...
requirejs(
  ...
  function (LayerManager, WorldWind) {
    ...
    path.altitudeMode = WorldWindConstants.CLAMP_TO_GROUND;
    ...
    function doCalc() {
      var distance = lengthMeasurer.getLength(
        pathPositions,
        false,
        WorldWindConstants.GREAT_CIRCLE
      );
      var terrainDistance = lengthMeasurer.getLength(
        pathPositions,
        true,
        WorldWindConstants.GREAT_CIRCLE
      );
      var geographicDistance = lengthMeasurer.getGeographicDistance(
        pathPositions,
        WorldWindConstants.GREAT_CIRCLE
      );
