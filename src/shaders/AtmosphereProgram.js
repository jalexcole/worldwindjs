...
class AtmosphereProgram extends GpuProgram{
  constructor(gl, vertexShaderSource, fragmentShaderSource, attribute) {
     ...
     * @readonly
     */
    this.atmosphereRadiusLocation = this.uniformLocation(
      gl,
      "atmosphereRadius"
    );
     ...
     * @readonly
     */
    this.atmosphereRadius2Location = this.uniformLocation(
      gl,
      "atmosphereRadius2"
    );
     ...
     * @readonly
     */
    this.scaleOverScaleDepthLocation = this.uniformLocation(
      gl,
      "scaleOverScaleDepth"
    );
  ...
  setScale(gl) {
    ...
    gl.uniform1f(
      ...
      1 / this.getAltitude() / this.rayleighScaleDepth
    );
  }
  /**
