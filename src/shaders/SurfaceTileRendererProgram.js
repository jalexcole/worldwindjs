 ...
 */
class SurfaceTileRendererProgram extends GpuProgram {
  ...
  constructor(gl) {
    ...
    super(
      gl,
      SurfaceTileRendererProgram.vertexShaderSource,
      SurfaceTileRendererProgram.fragmentShaderSource
    );
    ...
    this.texSamplerMatrixLocation = this.uniformLocation(
      gl,
      "texSamplerMatrix"
    );
  ...
  loadTexSampler(gl, unit) {
    gl.uniform1i(
      this.texSamplerLocation,
      unit - WebGLRenderingContext.TEXTURE0
    );
  }
  /**
   ...
   * @readonly
   */
  static key = "WorldWindGpuSurfaceTileRenderingProgram";
}
