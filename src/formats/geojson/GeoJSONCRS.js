...
class GeoJSONCRS {
    ...
    isCRSSupported() {
        try {
            ...
            Logger.log(
                ...
                "Unknown GeoJSON coordinate reference system (" +
                e +
                "): " +
    ...
    getLinkedCRSString(url, crsCallback) {
        ...
        xhr.onerror = function () {
            Logger.log(
                Logger.LEVEL_WARNING,
                "GeoJSON Linked CRS retrieval failed: " + url
            );
        };
        ...
        xhr.ontimeout = function () {
            Logger.log(
                Logger.LEVEL_WARNING,
                "GeoJSON Linked CRS retrieval timed out: " + url
            );
        };
