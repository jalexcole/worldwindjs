 ...
 * property.
 */
Shapefile.prototype.load = function (
  parserCompletionCallback,
  shapeConfigurationCallback,
  layer
) {
 ...
 */
Shapefile.prototype.defaultShapeConfigurationCallback = function (
  attributes,
  record
) {
  var configuration = {};
  ...
  var name =
    attributes.values.name || attributes.values.Name || attributes.values.NAME;
  if (name) {
