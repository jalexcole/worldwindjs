...
GeoTiffReader.prototype.parseBlock = function (
  returnElevation,
  compression,
  bytesPerPixel,
  blockByteCount,
  ...
  switch (compression) {
    case TiffConstants.Compression.UNCOMPRESSED:
      // Loop through pixels.
      for (
        var byteOffset = 0, increment = bytesPerPixel;
...
GeoTiffReader.prototype.parseImageFileDirectory = function (offset) {
  ...
  for (
    var i = offset + 2, directoryEntryCounter = 0;
    directoryEntryCounter < noOfDirectoryEntries;
