...
class KmlStyle extends KmlStyleSelector{
     ...
     * @returns {Object}
     */
    static placemarkAttributes(attributes) {
        ...
        attributes._imageOffset =
            attributes._imageOffset ||
            new Offset(WorldWindConstants.OFFSET_FRACTION, 0.5, WorldWindConstants.OFFSET_FRACTION, 0.5);
        ...
        attributes._labelAttributes =
            attributes._labelAttributes ||
            new TextAttributes(KmlStyle.textAttributes());
        attributes._drawLeaderLine = attributes._drawLeaderLine || false;
        attributes._leaderLineAttributes =
            attributes._leaderLineAttributes ||
            new ShapeAttributes(KmlStyle.shapeAttributes());
     ...
     * @returns {Object}
     */
    static textAttributes(attributes) {
        attributes = attributes || {};
        attributes._color = attributes._color || new Color(1, 1, 1, 1);
        attributes._font = attributes._font || new Font(14);
        attributes._offset =
            attributes._offset ||
            new Offset(WorldWindConstants.OFFSET_FRACTION, 0.5, WorldWindConstants.OFFSET_FRACTION, 0.0);
     ...
     * @returns {*|{}}
     */
    static shapeAttributes(attributes) {
        attributes = attributes || {};
        ...
        attributes._outlineStipplePattern =
            attributes._outlineStipplePattern || 0xf0f0;
        attributes._imageSource = attributes._imageSource || null;
        attributes._depthTest = attributes._depthTest || true;
