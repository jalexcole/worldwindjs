...
class KmlStyleResolver {
   ...
   * @private
   */
  handleStyleUrl(styleUrl) {
    var self = this;
    return this.handlePromiseOfFile(styleUrl)
   ...
   * @private
   */
  handleStyleSelector(styleSelector) {
