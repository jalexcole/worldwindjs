...
class KmlFeature extends KmlObject {
   ...
   */
  solveTimeVisibility(dc) {
    var timeRangeOfFeature =
      this.kmlTimePrimitive && this.kmlTimePrimitive.timeRange();
   ...
   */
  getStyle(dc, kmlOptions) {
    if (this._pStyle) {
      return;
    }

    var self = this;
    return kmlOptions.styleResolver
      .handleRemoteStyle(self.kmlStyleUrl, self.kmlStyleSelector)
