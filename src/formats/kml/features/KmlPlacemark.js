...
class KmlPlacemark extends KmlFeature{
    ...
    prepareAttributes(style, fileCache) {
        var options = (style && style.generate({}, fileCache)) || {
            normal: {},
            highlight: {},
        };
        var placemarkAttributes = new PlacemarkAttributes(
            KmlStyle.placemarkAttributes(options)
        );
    ...
    moveValidProperties() {
        ...
        this._renderable.altitudeMode =
            this.kmlAltitudeMode || WorldWindConstants.RELATIVE_TO_GROUND;
        this._renderable.enableLeaderLinePicking = true;
        this._renderable.imageRotation =
            this.style.normal.kmlIconStyle.kmlHeading || 0;
        this._renderable.imageRotationReference = WorldWindConstants.RELATIVE_TO_GLOBE;
    }
    /**
