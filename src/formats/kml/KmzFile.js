          ...
          Object.keys(zipFile.files)
            ...
            .map(function (file) {
              if (self.hasExtension("kml", file.name) && !rootFound) {
                ...
                return file.async("text").then(function (kmlTextRepresentation) {
                ...
                return file
                  ...
                  .then(function (kmlTextRepresentation) {
                    return new KmlFile(kmlTextRepresentation).then(
                      function (kmlFile) {
                ...
                return file.async("base64").then(function (mediaFile) {
