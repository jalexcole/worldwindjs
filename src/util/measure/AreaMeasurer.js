...
class AreaMeasurer {
   ...
   */
  getArea(positions, followTerrain, pathType) {
   ...
   * @return {Number} area in square meters
   */
  computeSurfaceAreaSampling(globe,
    positions,
    pathType) {
   ...
   * @return {Number} area in square meters
   */
  computeProjectedAreaGeometry(globe,
    positions,
    pathType) {
    // Subdivide long segments if needed
    this.subdividedPositions = MeasurerUtils.subdividePositions(
   ...
   * @return {Number} area in square meters
   */
  computeTriangleProjectedArea(globe, verts) {
   ...
   */
  tessellatePolygon(count, vertices) {
