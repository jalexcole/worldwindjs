...
class ShapeEditor {
  constructor(worldWindow) {
    ...
    this._moveControlPointAttributes.imageSource =
      WorldWindConfiguration.baseUrl + "images/blue-dot.png";
    ...
    this._shadowControlPointAttributes.imageSource =
      WorldWindConfiguration.baseUrl + "images/gray-dot.png";
    ...
    this._resizeControlPointAttributes.imageSource =
      WorldWindConfiguration.baseUrl + "images/yellow-dot.png";
    this._resizeControlPointAttributes.imageScale = 0.15;

    // Documented in defineProperties below.
    this._rotateControlPointAttributes = new PlacemarkAttributes(null);
    this._rotateControlPointAttributes.imageColor = Color.GREEN;
    this._rotateControlPointAttributes.imageSource =
      WorldWindConfiguration.baseUrl + "images/green-dot.png";
   ...
   * <code>false</code>.
   */
  enableCreator(shape, properties, layer) {
    this.stop();
