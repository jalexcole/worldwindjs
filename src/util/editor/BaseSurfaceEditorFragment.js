...
// Internal use only.
class BaseSurfaceEditorFragment {
  constructor() { }
  /**
  ...
  createControlPoint(controlPoints,
    attributes,
    purpose,
    index) {
  ...
  computeControlPointDelta(globe,
    positionA,
    positionB) {
  ...
  createRotationAccessory(accessories,
    attributes) {
  ...
  updateRotationAccessory(centerPosition,
  ...
  normalizedHeading(currentHeading,
    deltaHeading) {
    var newHeading = currentHeading * Angle.DEGREES_TO_RADIANS +
  ...
  computeShadowPointLocations(shape,
    shadowControlPoint,
    startLocation,
    endLocation) {
