...
SurfacePolylineEditorFragment.prototype = Object.create(
...
//Internal use only. Intentionally not documented.
SurfacePolylineEditorFragment.prototype.getShapeCenter = function (
  shape,
  globe
) {
...
// Internal use only.
SurfacePolylineEditorFragment.prototype.initializeControlElements = function (
  shape,
  controlPoints,
  shadowControlPoints,
  accessories,
...
// Internal use only.
SurfacePolylineEditorFragment.prototype.updateControlElements = function (
  shape,
  globe,
  controlPoints,
  shadowControlPoints,
...
// Internal use only.
SurfacePolylineEditorFragment.prototype.reshape = function (
  shape,
  globe,
  controlPoint,
  currentPosition,
...
// Internal use only.
SurfacePolylineEditorFragment.prototype.addNewVertex = function (
  shape,
  globe,
  position
) {
...
export default SurfacePolylineEditorFragment;
