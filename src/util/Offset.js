 ...
 * <ul>
 *     <li>[WorldWindConstants.OFFSET_FRACTION]{@link WorldWindConstants#OFFSET_FRACTION}</li>
 *     <li>[WorldWindConstants.OFFSET_INSET_PIXELS]{@link WorldWindConstants#OFFSET_INSET_PIXELS}</li>
 *     <li>[WorldWindConstants.OFFSET_PIXELS]{@link WorldWindConstants#OFFSET_PIXELS}</li>
 * </ul>
...
class Offset {
   ...
   */
  offsetForSize(width, height) {
    var x, y;

    if (this.xUnits === WorldWindConstants.OFFSET_FRACTION) {
      x = width * this.x;
    } else if (this.xUnits === WorldWindConstants.OFFSET_INSET_PIXELS) {
      x = width - this.x;
    } else {
    ...
    if (this.yUnits === WorldWindConstants.OFFSET_FRACTION) {
      y = height * this.y;
    } else if (this.yUnits === WorldWindConstants.OFFSET_INSET_PIXELS) {
      y = height - this.y;
    } else {
      // default to OFFSET_PIXELS
      y = this.y;
