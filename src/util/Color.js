...
class Color {
   ...
   */
  static colorFromByteArray(bytes) {
    return new Color(
      bytes[0] / 255,
      bytes[1] / 255,
      bytes[2] / 255,
   ...
   * @returns {Color} The constructed color.
   */
  static colorFromBytes(redByte, greenByte, blueByte, alphaByte) {
    return new Color(
      redByte / 255,
      greenByte / 255,
      blueByte / 255,
