...
const Logger = {
  ...
  messageTable: {
    ...
    abstractInvocation:
      "The function called is abstract and must be overridden in a subclass.",
    ...
    missingAttributeName:
      "The specified DBase attribute file name is null or undefined.",
    missingArray:
      "The specified array is null, undefined or of insufficient length.",
    ...
    missingGlContext:
      "The specified WebGL rendering context is null or undefined.",
    ...
    webglNotSupported:
      "The browser does not support WebGL, or WebGL is disabled.",
  },

  loggingLevel: 1, // log severe messages by default
};
