...
HeatMapLayer.prototype.filterGeographically = function (data, sector) {
  ...
  var extraLongitudeBefore = 0,
    extraLongitudeAfter = 0;
 ...
 */
HeatMapLayer.prototype.gatherGeographical = function (
  data,
  result,
  sector,
  minLatitude,
 ...
 */
HeatMapLayer.prototype.calculateExtendedSector = function (
  sector,
