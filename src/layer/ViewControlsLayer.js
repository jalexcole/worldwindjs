...
ViewControlsLayer.prototype.pickControl = function (e) {
  ...
  var x = pickPoint[0],
    y = this.wwd.canvas.height - pickPoint[1],
    control;
    ...
    var setLookAtLocation = function () {
      if (thisLayer.activeControl) {
        var dx = thisLayer.panControlCenter[0] - thisLayer.currentEventPoint[0],
          ...
          scale =
            thisLayer.panIncrement *
            (lookAt.range / thisLayer.wwd.globe.radiusAt(oldLat, oldLon)),
          heading =
            lookAt.heading + Math.atan2(dx, dy) * Angle.RADIANS_TO_DEGREES,
    ...
    var setExaggeration = function () {
      if (thisLayer.activeControl) {
        if (thisLayer.activeControl === thisLayer.exaggerationUpControl) {
          ...
          thisLayer.activeControl === thisLayer.exaggerationDownControl
        ) {
