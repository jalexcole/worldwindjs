...
import GmlBoundedBy from "../gml/GmlBoundedBy";
import GmlDomainSet from "../gml/GmlDomainSet";
import GmlRectifiedGrid from "../gml/GmlRectifiedGrid";
import Logger from "../../util/Logger";
import OwsKeywords from "../ows/OwsKeywords";
...
WcsCoverageDescriptions.prototype.getSector = function (coverageId) {
  ...
  var coverage = this.getCoverage(coverageId),
    envelope;
...
WcsCoverageDescriptions.prototype.getResolution = function (coverageId) {
  ...
  var coverage = this.getCoverage(coverageId),
    sector = this.getSector(coverageId),
    xLow,
    yLow,
    xHigh,
    yHigh,
...
WcsCoverageDescriptions.prototype.getCoverage = function (coverageId) {
  for (var i = 0, len = this.coverages.length; i < len; i++) {
    if (
      coverageId === (this.coverages[i].coverageId || this.coverages[i].name)
    ) {
...
WcsCoverageDescriptions.prototype.assembleCoverages100 = function (element) {
  ...
  for (var c = 0; c < children.length; c++) {
    ...
    if (child.localName === "name") {
      ...
      coverage.supportedInterpolations =
        this.assembleSupportedInterpolations100(child);
...
// Internal. Intentionally not documented.
WcsCoverageDescriptions.prototype.assembleServiceParameters20x = function (
  element
) {
  var children = element.children || element.childNodes,
    serviceParameters = {};
...
// Internal. Intentionally not documented.
WcsCoverageDescriptions.prototype.assembleLonLatEnvelope100 = function (
  element
) {
  var children = element.children || element.childNodes,
    latLonEnvelope = {};
  ...
  for (var c = 0; c < children.length; c++) {
    ...
    if (child.localName === "pos") {
      ...
      latLonEnvelope.pos.push(
        WcsCoverageDescriptions.parseSpacedFloatArray(child.textContent)
      );
    }
  }
...
// Internal. Intentionally not documented.
WcsCoverageDescriptions.prototype.assembleSupportedFormats100 = function (
  element
) {
  var children = element.children || element.childNodes,
    supportedFormats = {};
...
// Internal. Intentionally not documented.
WcsCoverageDescriptions.prototype.assembleSupportedInterpolations100 =
  function (element) {
    var children = element.children || element.childNodes,
...
// Internal. Intentionally not documented.
WcsCoverageDescriptions.prototype.assembleSpatialDomain100 = function (
  element
) {
  var children = element.children || element.childNodes,
    spatialDomain = {};
...
// Internal. Intentionally not documented.
WcsCoverageDescriptions.prototype.assembleRangeSetElement100 = function (
  element
) {
  var children = element.children || element.childNodes,
    rangeSet = {};
  ...
  for (var c = 0; c < children.length; c++) {
    ...
    if (child.localName === "name") {
      ...
      rangeSet.axisDescriptions =
        this.assembleRangeSetAxisDescription100(child);
    }
  }
...
// Internal. Intentionally not documented.
WcsCoverageDescriptions.prototype.assembleRangeSetAxisDescription100 =
  function (element) {
    var children = element.children || element.childNodes,
      axisDescriptions = [];
    ...
    for (var c = 0; c < children.length; c++) {
      ...
      if (child.localName === "AxisDescription") {
        axisDescriptions.push(
          this.assembleRangeSetAxisDescriptionElement100(child)
        );
      }
    }
...
// Internal. Intentionally not documented.
WcsCoverageDescriptions.prototype.assembleRangeSetAxisDescriptionElement100 =
  function (element) {
    var children = element.children || element.childNodes,
      axisDescription = {};
...
// Internal. Intentionally not documented.
WcsCoverageDescriptions.prototype.assembleRangeSetValues100 = function (
  element
) {
  var children = element.children || element.childNodes,
    values = {};
