...
class WcsCoverageDescriptions {
  ...
  static parseSpacedFloatArray(line) {
  ...
  getResolution(coverageId) {
    ...
    var coverage = this.getCoverage(coverageId), sector = this.getSector(coverageId), xLow, yLow, xHigh, yHigh, xRes, yRes;
  ...
  // Internal. Intentionally not documented.
  assembleServiceParameters20x(element) {
  ...
  // Internal. Intentionally not documented.
  assembleLonLatEnvelope100(element) {
  ...
  // Internal. Intentionally not documented.
  assembleSupportedCrs100(element) {
  ...
  // Internal. Intentionally not documented.
  assembleSupportedFormats100(element) {
  ...
  // Internal. Intentionally not documented.
  assembleSupportedInterpolations100(element) {
  ...
  // Internal. Intentionally not documented.
  assembleSpatialDomain100(element) {
  ...
  // Internal. Intentionally not documented.
  assembleRangeSetElement100(element) {
    var children = element.children || element.childNodes, rangeSet = {};
  ...
  // Internal. Intentionally not documented.
  assembleRangeSetAxisDescription100(element) {
  ...
  // Internal. Intentionally not documented.
  assembleRangeSetAxisDescriptionElement100(element) {
  ...
  // Internal. Intentionally not documented.
  assembleRangeSetValues100(element) {
