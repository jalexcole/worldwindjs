...
var ScreenCreditController = function () {
   ...
   */
  this.creditPlacement = new Offset(
 ...
 */
ScreenCreditController.prototype.addCredit = function (
  creditString,
  color,
  hyperlinkUrl
) {
  ...
  credit.attributes.offset = new Offset(
...
ScreenCreditController.prototype.doRender = function (dc) {
  var point = this.creditPlacement.offsetForSize(
    dc.viewport.width,
    dc.viewport.height
  );
