...
define([
    ...
    function (Angle,
        ...
        ProjectionWgs84.prototype.geographicToCartesianTransform = function (globe, latitude, longitude, altitude, result) {
            if (!globe) {
                throw new ArgumentError(Logger.logMessage(Logger.LEVEL_SEVERE, "ProjectionWgs84", "geographicToCartesianTransform", "missingGlobe"));
            }

            if (!result) {
                throw new ArgumentError(Logger.logMessage(Logger.LEVEL_SEVERE, "ProjectionWgs84", "geographicToCartesianTransform", "missingResult"));
            }

            var radLat = latitude * Angle.DEGREES_TO_RADIANS;
            var radLon = longitude * Angle.DEGREES_TO_RADIANS;
