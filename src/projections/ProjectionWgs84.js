...
ProjectionWgs84.prototype.geographicToCartesian = function (
  globe,
  latitude,
  longitude,
  altitude,
  ...
  var cosLat = Math.cos(latitude * Angle.DEGREES_TO_RADIANS),
    ...
    rpm =
      ...
      Math.sqrt(1.0 - globe.eccentricitySquared * sinLat * sinLat);
...
// Documented in base class.
ProjectionWgs84.prototype.geographicToCartesianGrid = function (
  globe,
  sector,
  numLat,
  numLon,
  ...
  for (
    ...
    for (lonIndex = 0; lonIndex < numLon; lonIndex++) {
      ...
      result[resultIndex++] =
        (rpm + elev) * cosLat * sinLon[lonIndex] - refCenter[0];
      result[resultIndex++] =
        (rpm * (1.0 - globe.eccentricitySquared) + elev) * sinLat -
        refCenter[1];
      result[resultIndex++] =
        (rpm + elev) * cosLat * cosLon[lonIndex] - refCenter[2];
    }
  }
...
// Documented in base class.
ProjectionWgs84.prototype.cartesianToGeographic = function (
  globe,
  x,
  y,
  z,
...
ProjectionWgs84.prototype.northTangentAtLocation = function (
  globe,
  latitude,
  longitude,
  result
...
ProjectionWgs84.prototype.northTangentAtPoint = function (
  globe,
  x,
  y,
  z,
  ...
  return this.northTangentAtLocation(
    globe,
    this.scratchPosition.latitude,
    this.scratchPosition.longitude,
    result
  );
};

ProjectionWgs84.prototype.surfaceNormalAtLocation = function (
  globe,
  latitude,
  longitude,
  result
...
ProjectionWgs84.prototype.surfaceNormalAtPoint = function (
  globe,
  x,
  y,
  z,
