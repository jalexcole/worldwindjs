 ...
 */
class ProjectionMercator extends GeographicProjection {
  constructor() {
    super(
      "Mercator",
      true,
  ...
  geographicToCartesian(globe,
    ...
    var ecc = Math.sqrt(globe.eccentricitySquared), sinLat = Math.sin(latitude * Angle.DEGREES_TO_RADIANS), s = ((1 + sinLat) / (1 - sinLat)) *
