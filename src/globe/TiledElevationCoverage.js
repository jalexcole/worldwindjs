...
var TiledElevationCoverage = function (config) {
  ...
  var firstLevelDelta = 45,
    tileWidth = 256,
    lastLevel = LevelSet.numLevelsForResolution(
...
TiledElevationCoverage.prototype.minAndMaxElevationsForSector = function (
  sector,
  result
) {
  if (!sector) {
...
// Documented in super class
TiledElevationCoverage.prototype.elevationAtLocation = function (
  latitude,
  longitude
) {
...
// Documented in super class
TiledElevationCoverage.prototype.elevationsForGrid = function (
  sector,
  numLat,
  numLon,
  result
  ...
  var gridResolution =
    (sector.deltaLatitude() / (numLat - 1)) * Angle.DEGREES_TO_RADIANS;
...
TiledElevationCoverage.prototype.pointElevationForLocation = function (
  latitude,
  longitude
) {
...
// Intentionally not documented.
TiledElevationCoverage.prototype.pointElevationsForGrid = function (
  sector,
  numLat,
  numLon,
  level,
...
TiledElevationCoverage.prototype.areaElevationsForGrid = function (
  sector,
  numLat,
  numLon,
  level,
...
TiledElevationCoverage.prototype.areaElevationForCoord = function (
  s,
  t,
  levelNumber,
  result,
...
TiledElevationCoverage.prototype.lookupPixels = function (
  x0,
  x1,
  y0,
  y1,
...
TiledElevationCoverage.prototype.lookupImage = function (
  levelNumber,
  row,
  column,
  retrieveTiles
...
// Intentionally not documented.
TiledElevationCoverage.prototype.assembleTiles = function (
  level,
  sector,
  retrieveTiles
) {
...
// Intentionally not documented.
TiledElevationCoverage.prototype.addTileOrAncestor = function (
  level,
  row,
  column,
  retrieveTiles
...
// Intentionally not documented.
TiledElevationCoverage.prototype.addAncestor = function (
  level,
  row,
  column,
  retrieveTiles
...
// Intentionally not documented.
TiledElevationCoverage.prototype.tileForLevel = function (
  levelNumber,
  row,
  column
) {
...
TiledElevationCoverage.prototype.retrieveTileImage = function (tile) {
  if (
    this.currentRetrievals.length < this.retrievalQueueSize &&
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        ...
        if (xhr.status === 200) {
          if (
            contentType === elevationCoverage.retrievalImageFormat ||
...
// Intentionally not documented
TiledElevationCoverage.prototype.removeFromCurrentRetrievals = function (
  tileKey
) {
