 ...
 */
Matrix.prototype.multiplyByFirstPersonModelview = function (
  eyePosition,
  heading,
  tilt,
  roll,
 ...
 */
Matrix.prototype.multiplyByLookAtModelview = function (
  lookAtPosition,
  range,
  heading,
  tilt,
 ...
 */
Matrix.prototype.setToPerspectiveProjection = function (
  viewportWidth,
  viewportHeight,
  fovyDegrees,
  nearDistance,
 ...
 */
Matrix.prototype.setToScreenProjection = function (
  viewportWidth,
  viewportHeight
) {
  if (viewportWidth <= 0) {
 ...
 */
Matrix.prototype.extractViewingParameters = function (
  origin,
  roll,
  globe,
  result
 ...
 */
Matrix.prototype.eigensystemFromSymmetricMatrix = function (
  result1,
  result2,
  result3
) {
