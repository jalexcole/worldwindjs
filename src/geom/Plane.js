...
class Plane {
  ...
  transformByMatrix(matrix) {
    ...
    var x =
        matrix[0] * this.normal[0] +
        matrix[1] * this.normal[1] +
        matrix[2] * this.normal[2] +
        matrix[3] * this.distance,
      y =
        matrix[4] * this.normal[0] +
        matrix[5] * this.normal[1] +
        matrix[6] * this.normal[2] +
        matrix[7] * this.distance,
      z =
        matrix[8] * this.normal[0] +
        matrix[9] * this.normal[1] +
        matrix[10] * this.normal[2] +
        matrix[11] * this.distance,
      distance =
        matrix[12] * this.normal[0] +
        matrix[13] * this.normal[1] +
        matrix[14] * this.normal[2] +
        matrix[15] * this.distance;
   ...
   */
  intersectsSegment(endPoint1, endPoint2) {
   ...
   * @returns {Boolean} true If the line segment intersects this plane, otherwise false.
   */
  intersectsSegmentAt(endPoint1, endPoint2, result) {
