...
class Position {
   ...
   */
  static fromRadians(latitudeRadians, longitudeRadians, altitude) {
    return new Position(
  ...
  static interpolateGreatCircle(amount,
    ...
    result.altitude = WWMath.interpolate(
      t,
      position1.altitude,
      position2.altitude
    );
   ...
   * @throws {ArgumentError} If either specified position or the result argument is null or undefined.
   */
  static interpolateRhumb(amount, position1, position2, result) {
    if (!position1 || !position2) {
      throw new ArgumentError(
        Logger.logMessage(
          Logger.LEVEL_SEVERE,
   ...
   * @throws {ArgumentError} If either specified position or the result argument is null or undefined.
   */
  static interpolateLinear(amount, position1, position2, result) {
    if (!position1 || !position2) {
      throw new ArgumentError(
        Logger.logMessage(
          Logger.LEVEL_SEVERE,
