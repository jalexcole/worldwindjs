...
BoundingBox.prototype.getCorners = function () {
  ...
  for (var i = 0; i < 4; i++) {
    corners.push(
      new Vec3(this.bottomCenter[0], this.bottomCenter[1], this.bottomCenter[2])
    );
  }
 ...
 */
BoundingBox.prototype.setToSector = function (
  sector,
  globe,
  minElevation,
  maxElevation
...
// Internal. Intentionally not documented.
BoundingBox.prototype.intersectsAt = function (
  plane,
  effRadius,
  endPoint1,
  endPoint2
...
// Internal. Intentionally not documented.
BoundingBox.prototype.adjustExtremes = function (
  r,
  rExtremes,
  s,
  sExtremes,
