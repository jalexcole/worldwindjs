...
define([
  ...
  var USGSWells = function () {
    ...
    this.addWellShape(
      ...
      270,
      30,
      "Lake Hodges - SDSY (13S/2W-12M1-3)\nPerforation depth 170-250 (ft)",
      layer
    );
    ...
    this.addWellShape(
      ...
      1120,
      30,
      "San Elijo - SDSE (13S/4W-26Q1-3)\nPerforation depth 300-1220 (ft)",
      layer
    );
    ...
    this.addWellShape(
      ...
      940,
      30,
      "Aqua Culture - SDAQ (16S/2W-18J3-7)\nPerforation depth 840-940 (ft)",
      layer
    );
    ...
    this.addWellShape(
      ...
      1100,
      30,
      "Chollas Park - SDCP (16S/2W-34G1-6)\nPerforation depth 920-1060 (ft)",
      layer
    );
    ...
    this.addWellShape(
      ...
      1490,
      30,
      "Balboa Park - SDBP (17S/3W-1K1-5)\nPerforation depth 1470-1490 (ft)",
      layer
    );
    this.addWellShape(
      32.718938,
      ...
      1620,
      30,
      "Home & Federal - SDHF (17S/2W-5Q1-6)\nPerforation depth 1580-1620 (ft)",
      layer
    );
    ...
    this.addWellShape(
      ...
      1500,
      30,
      "Naval Base - SDNB (17S/2W-20F1-5)\nPerforation depth 1460-1500 (ft)",
      layer
    );
    ...
    this.addWellShape(
      ...
      1990,
      30,
      "Sweetwater - SDSW (17S/2W-28R4-9)\nPerforation depth 1810-1850 (ft)",
      layer
    );
    ...
    this.addWellShape(
      ...
      1720,
      30,
      "Country Club - SDCC (18S/2W-11P1-6)\nPerforation depth 1660-1700 (ft)",
      layer
    );
    ...
    this.addWellShape(
      ...
      1472,
      30,
      "Otay River - SDOR (18S/2W-23G2-6)\nPerforation depth 1420-1460 (ft)",
      layer
    );
  ...
  USGSWells.prototype.addWellShape = function (
    latitude,
    longitude,
    depthFeet,
    radiusFeet,
    ...
    var boundary = [],
      ...
      radius =
        (radiusFeet * feetToMeters) /
        this.wwd.globe.radiusAt(latitude, longitude),
      numSegments = 32,
      da = 360 / numSegments;
    ...
    for (var i = 0, len = numSegments + 1; i < len; i++) {
      ...
      boundary.push(
        WorldWind.Location.greatCircleLocation(center, angle, radius, position)
      );
    }

    var polygon = new WorldWind.Polygon([boundary]);
    polygon.pickDelegate = displayText;
    polygon.altitudeMode = WorldWindConstants.RELATIVE_TO_GROUND;
    polygon.extrude = true;
    polygon.attributes.interiorColor = new WorldWind.Color(
      0.22,
      0.65,
      0.87,
      1.0
    ...
    polygon.highlightAttributes = new WorldWind.ShapeAttributes(
      polygon.attributes
    );
    ...
    var placemark = new WorldWind.Placemark(
      new WorldWind.Position(latitude, longitude, 0)
    );
    ...
    placemark.attributes.imageSource =
  ...
  USGSWells.prototype.setupPicking = function () {
    ...
    this.screenText.attributes.offset = new WorldWind.Offset(
      ...
      if (pickList.objects.length > 0) {
        for (var p = 0; p < pickList.objects.length; p++) {
          ...
          if (typeof pickedObject.userObject === "string") {
            ...
            this.screenText.screenOffset.y =
              this.wwd.viewport.width - pickPoint[1];
