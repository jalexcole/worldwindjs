...
require(["../../src/WorldWind", "../util/ProjectionMenu"], function (
  ww,
  ProjectionMenu
) {
  "use strict";
  ...
  function selectModel(event) {
    ...
    colladaLoader.init({
      dirPath: "./Collada/collada_models/" + model.path + "/",
    });
    colladaLoader.load(model.fileName, function (scene) {
      ...
      if (scene) {
        ...
        scene.altitudeMode = WorldWindConstants.ABSOLUTE;
