...
define([
  ...
  var SubSurface = function () {
    ...
    var shapefileLibrary =
      "https://worldwind.arc.nasa.gov/web/apps/data/shapefiles/springfield";
    ...
    var shapeConfigurationCallback = function (attributes, record) {
      ...
      if (record.isPolylineType()) {
        ...
        if (attributes.values.ELEVATION) {
          ...
          configuration.altitudeMode = WorldWindConstants.ABSOLUTE;
        }
    ...
    var pipesShapefile = new WorldWind.Shapefile(
      shapefileLibrary + "/wastewaterpipemains.shp"
    );
    pipesShapefile.load(null, shapeConfigurationCallback, pipesLayer);

    var manholesShapefile = new WorldWind.Shapefile(
      shapefileLibrary + "/wastewatermanholes.shp"
    );
    ...
    var surfaceShape = new WorldWind.SurfaceCircle(
      new WorldWind.Location(44.05, -123),
      5e3,
      surfaceAttributes
    );
